...
const trydbrouter = express.Router();
...
//register endpoint
trydbrouter.post("/Register", upload.fields([{ name: 'Picture', maxCount: 1 },
]), StdsignUpValidationRules, async (req, res) => {
  try {
